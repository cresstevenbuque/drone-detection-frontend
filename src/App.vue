...
<template>
    <<<<<<< HEAD <div
        class="h-screen flex flex-col bg-slate-900 text-slate-200 antialiased overflow-hidden font-sans relative">
        ...
        <div class="h-screen flex flex-col bg-slate-900 text-slate-200 antialiased overflow-hidden font-sans">
            ...
            <header class="bg-slate-950 border-b border-slate-800 p-4 flex justify-between items-center shadow-lg z-20">
                <div class="flex items-center gap-3">
                    ...
                    <div>
                        <<<<<<< HEAD <h1 class="font-bold text-lg tracking-wide text-white uppercase">Aerial Threat
                            Detection</h1>
                            =======
                            <h1 class="font-bold text-lg tracking-wide text-white">AERIAL THREAT DETECTION</h1>
                            >>>>>>> b6556c49e6b9e99dee4f4d6bd069d081a722eead
                            <p class="text-xs text-slate-400 uppercase tracking-widest">System Prototype v1.0 • Ready
                                for Integration</p>
                    </div>
                </div>
            ...
            <div class="flex items-center gap-6">
                ...
                <button @click="toggleSystem" <<<<<<< HEAD :disabled="!mediaFile || isProcessing"
                    ...
                    =======
                    :disabled="!mediaFile"
                    class="px-6 py-2 rounded font-bold text-sm transition-all duration-200 flex items-center gap-2
                    disabled:opacity-50 disabled:cursor-not-allowed"
                    :class="isSystemActive ? 'bg-red-500 hover:bg-red-600 text-white
                    shadow-[0_0_15px_rgba(239,68,68,0.5)]' : 'bg-emerald-600 hover:bg-emerald-500 text-white
            ...
            <<<<<<< HEAD <main class="flex-1 grid grid-cols-12 gap-0 overflow-hidden">
                    ...
                    <main class="flex-1 grid grid-cols-12 gap-0 overflow-hidden">
                        ...
                        <div
                            ...
                            <div v-if="!mediaFile"
                                ...
                                <p class="text-slate-500 text-sm mb-6">Select drone footage (MP4) or aerial imagery
                                    (JPG/PNG)</p>
                                <<<<<<< HEAD <label
                                    class="cursor-pointer bg-slate-700 hover:bg-slate-600 text-white px-6 py-3 rounded-lg font-bold transition inline-block">
                                    =======
                            ...
                            <<<<<<< HEAD <div v-else
                                ...
                                <video v-if="mediaType === 'video'" :src="mediaUrl" controls
                                    class="max-w-full max-h-full" :autoplay="isSystemActive"></video>
                                ...
                                <div v-if="isProcessing"
                                    ...
                                    <div class="w-full max-w-md px-10">
                                        <div class="flex justify-between mb-2">
                                            <span
                                                class="text-emerald-500 text-[10px] tracking-[0.3em] animate-pulse">ESTABLISHING
                                                LINK...</span>
                                ...
                                <div v-if="isSystemActive && !isProcessing"
                                    class="absolute inset-0 hud-grid pointer-events-none">
                ...
                <div class="col-span-12 lg:col-span-3 bg-slate-900 flex flex-col h-full">
                    ...
                    <div class="p-6 border-b border-slate-800">
                        <h2 class="text-xs font-bold text-slate-500 uppercase mb-4 tracking-wider">Detection Analytics
                        </h2>
                    ...
                    <<<<<<< HEAD=======<!-- Logs -->
                        ...
                        <div class="flex-1 flex flex-col overflow-hidden">
                            ...
                            <<<<<<< HEAD <div ref="logContainer"
                                class="flex-1 overflow-y-auto p-4 font-mono text-[10px] space-y-2 bg-black/20 scroll-smooth">
...
.hud-grid {
    background-image:
        <<<<<<< HEAD linear-gradient(rgba(16, 185, 129, 0.05) 1px, transparent 1px),
...
.scan-line {
    width: 100%;
    height: 2px;
    <<<<<<< HEAD background: linear-gradient(to right, transparent, rgba(16, 185, 129, 0.5), transparent);
    position: absolute;
    top: 0;
    left: 0;
...
>>>>>>>b6556c49e6b9e99dee4f4d6bd069d081a722eead @keyframes scan {
    0% {
        top: 0%;
    }
